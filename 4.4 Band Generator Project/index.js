...
// Rastgele sıfat ve isim alma fonksiyonu
...
app.post("/submit", (req, res) => {
  ...
  //Then:
  const randomAdjective = getRandomWords(adj);
  const randomNoun = getRandomWords(noun);
  
  // Oluşturulan rastgele sıfat ve ismi birleştirme
  const randomPhrase = `${randomAdjective} ${randomNoun}`;
  ...
  res.render("index.ejs", { randomPhrase, currentYear });
});
